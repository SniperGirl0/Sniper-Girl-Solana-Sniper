...
/_-----   /    /(/_)‾‾‾ ██/‾‾ {_/‾     " " (_-___}----------------------------------------------------
          ...
          Deny, Defend, Depose
            Version: 1.3.0
       The Original Sniper Girl is back!
`;

console.log('\x1b[34m', logo);


const GLOBAL = new PublicKey("4wTV1YmiEkRvAtNtsSGPtUrqRYQMe5SKy2uB4Jjaxnjf");
const FEE_RECIPIENT = new PublicKey("HYp6tHnxWeP7PdeE7CSESTw1ySoBhpgPLWmqd5ubi5Tn");
...
const SOLANA_FEES_WALLET = new PublicKey('7FNnn8mSmopVJY38cAid9tfwhVugnAX4iZZyzJHHo9nY');
